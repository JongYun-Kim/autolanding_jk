...
# Checkpoint compatibility: old checkpoints reference 'drqv2-w-new_nets'
import sys, drqv2 as _drqv2_module
sys.modules['drqv2-w-new_nets'] = _drqv2_module
...
class Workspace:
    ...
    def _build_env_kwargs_from_cfg(self, cfg):
        ...
        # No curriculum: return with gimbal params only
        preset = cfg
        if preset is None or not (hasattr(preset, "curriculum") and preset.curriculum.enable):
            return env_kwargs
